...
all_text = " ".join(job_desctiptions).lower()
...
# List skills to be extracted: 
skill_list = {"python", "sql", "aws", "docker", "tableau", "excel", "pandas", "numpy", "powerbi", "spark", "machine learning", "nlp", "cloud computing"}
