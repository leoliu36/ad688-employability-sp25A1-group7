...
## External Skills Assessment via Text Mining
To identify the most in-demand skills in the analytics job market, we analyzed the job descriptions from the Lightcast dataset by text mining the BODY column which contained detailed job descriptions. Below is a summary of the data preparation and extraction process:
...
```
![Most In-demand skills from Job Descriptions](figures/jd_top_skills.png)
