...
![Figure 9: KMeans Clusters by Salary and Min Years Experience](figures/KMeans_Cluster.png)
{{< include _setup.qmd >}}
```{python}
import pandas as pd
...
plt.close()
```
![Figure 10: Predicted vs. Actual Salary (Random Forest Regression)](figures/Predicted_vs_Actual_RF_Regression.png)
...
plt.close()
```
![Figure 11: Top 5 Feature Importances (Random Forest Regression)](figures/Top_5_Feature_Importances_RF_Regression.png)
...
![Figure 12: Top 5 Outlier Job Salaries](figures/Top_5_Outlier_Job_Salaries.png)
...
plt.close()
```
![Figure 13: Confusion Matrix — Remote vs On-Site Classification](figures/Confusion_Matrix_Remote_vs_On-Site.png)
